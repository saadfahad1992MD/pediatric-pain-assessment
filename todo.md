...
## Enhancement - Weight-Based Dose Calculator

- [x] Add patient weight input field (kg)
- [x] Calculate exact doses based on weight for each medication
- [x] Display calculated dose with min/max range
- [x] Show dose per kg alongside calculated dose
- [x] Add weight validation (reasonable pediatric weight range)
- [x] Include max dose warnings when calculated dose exceeds maximum
- [x] Format doses appropriately (mg, mL based on concentration)
- [x] Add dose rounding for practical administration
